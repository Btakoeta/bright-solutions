...
export default function SustainabilityCarousel() {
  ...
  return (
    <div className="relative h-96 lg:h-full group">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-bright-green/20 to-blue-500/20 rounded-3xl border border-bright-green/30 backdrop-blur-sm overflow-hidden">
        {/* Image */}
        <img
      ...
      <button
        ...
        className="absolute left-4 top-1/2 -translate-y-1/2 z-30 bg-bright-green/80 hover:bg-bright-green text-white p-2 rounded-full transition opacity-0 group-hover:opacity-100 transform hover:scale-110"
      >
      ...
      <button
        ...
        onMouseEnter={() => setIsAutoPlay(false)}
        onMouseLeave={() => setIsAutoPlay(true)}
        className="absolute right-4 top-1/2 -translate-y-1/2 z-30 bg-bright-green/80 hover:bg-bright-green text-white p-2 rounded-full transition opacity-0 group-hover:opacity-100 transform hover:scale-110"
      >
      ...
      {/* Info Card */}
      <div className="absolute -bottom-6 -right-6 bg-gray-900 border border-bright-green/30 rounded-2xl p-6 backdrop-blur-sm max-w-sm animate-slide-up z-40">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">Know exactly when your truck arrives</p>
          </div>
        </div>
      </div>
    </div>
